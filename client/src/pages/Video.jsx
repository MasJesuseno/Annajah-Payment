...
import { getVideoTv, createVideoTv, updateVideoTv, deleteVideoTv, reorderVideoTv } from '../api'
import { Video, Plus, Edit2, Trash2, X, Eye, EyeOff, Youtube, ArrowUp, ArrowDown } from 'lucide-react'
...
export default function VideoTv() {
  ...
  const moveVideo = async (index, direction) => {
    ...
    try {
      ...
      await reorderVideoTv(orders)
      toast.success('Urutan video berhasil diubah')
    } catch {
      // Rollback on error
      loadData()
      toast.error('Gagal mengubah urutan video')
    }
  }
      ...
      <div className="card p-0 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr>
                <th className="table-header text-center w-16">Urutan</th>
                ...
                <th className="table-header text-right w-28">Aksi</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                  ...
                  <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                    <td className="table-cell text-center">
                      <div className="flex items-center justify-center gap-1">
                          ...
                          <button
                            ...
                            className={`p-0.5 rounded transition-colors ${
                              isFirst
                                ...
                                : 'text-gray-400 hover:text-annajah-600 hover:bg-annajah-50'
                            }`}
                        ...
                        <span className="text-sm text-gray-500 font-medium min-w-[18px]">{idx + 1}</span>
                      </div>
                    </td>
