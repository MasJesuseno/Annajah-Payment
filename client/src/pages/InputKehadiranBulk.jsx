...
import { getSiswa, getKelas, createKehadiranBulk, getKehadiran, getPengaturan } from '../api'
import {
  Calendar, Check, X, UserCheck, UserX, Clock, Activity,
  Save, Loader2, Users, School,
  AlertCircle, Edit3, History
} from 'lucide-react'
...
export default function InputKehadiranBulk() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Input Kehadiran Siswa Masal</h1>
      ...
      {!selectedKelas && (
        <div className="flex flex-col items-center justify-center py-20 text-gray-400">
          <School className="w-16 h-16 mb-4 opacity-30" />
          <p className="text-sm font-medium text-gray-500">Pilih kelas untuk mulai mengisi kehadiran</p>
          <p className="text-xs text-gray-300 mt-1">Pilih kelas dari dropdown di atas</p>
        </div>
      )}
    </div>
  )
